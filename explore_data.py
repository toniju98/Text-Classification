...
class ExploreData:
    """class with methods for exploring the data
    """
    ...
    def get_num_words_per_sample(self):
        ...
        """
        num_words = [len(s.split()) for s in self.data['text']]
    ...
    def plot_sample_length_distribution(self, sample_texts):
        """Plots the sample length distribution.

        # Arguments
            samples_texts: list, sample texts.
        """
        plt.hist([len(s) for s in self.data[sample_texts]], 50)
